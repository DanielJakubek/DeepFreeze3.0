  ...
  <div class="container">
    <div class="row">
      <div class="col clearfix">
        <h1 class="text-center">Affordable and Clean Energy</h1>
        </br>
        <h2 class="text-center">
          Our main goal is to supply clean Energy
        </h2>
          ...
          <div class="accordion-item">
            ...
            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
              ...
              <div class="accordion-body">
                <img src="../Images/7.jpg" class="float-md-end mb-3 ms-md-3" alt="placeholder"
