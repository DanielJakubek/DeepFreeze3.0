  ...
  <div class="container">
    <div class="row">
      <div class="col clearfix">
        <h1 class="text-center">Clean Water and Sanitation</h1>
      </br>
        <h2 class="text-center">
          Our main goal is to supply clean water and Sanitation
        </h2>
        ...
        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordion1">
          <div class="accordion-body">
            <img src="../Images/6.jpg" class="float-md-end mb-3 ms-md-3" alt="placeholder" style="max-width:250px; max-height:250px;">
              <p>
              <?php
                    include "../Include/printPageGoals.php";
                    printData("1","Clean-Water-And-Sanitation");
      ...
      <div class="accordion-item">
        ...
        <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="header2" data-bs-parent="#accordion1">
          <div class="accordion-body">
            ...
            <p>
            <?php
                    printData("2","Clean-Water-And-Sanitation");
      ...
      <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordion1">
        <div class="accordion-body">
          <div class="container">
            ...
            <p>
            <?php
                    printData("3","Clean-Water-And-Sanitation");
    ...
    <div class="container" id="container2">
      <div class="col">
        ...
        <div class="infoPopup" id="infoPage" style="display: none;" >
          ...
          <?php
                    printData("4","Clean-Water-And-Sanitation");
