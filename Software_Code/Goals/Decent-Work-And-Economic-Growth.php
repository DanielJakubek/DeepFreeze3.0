  ...
  <div class="container">
    <div class="row">
      <div class="col clearfix">
        <h1 class="text-center">Decent Work and Ecconomic Growth</h1>
      </br>
        <h2 class="text-center">
          Our main goal is to get work to facilitate economic growth
        </h2>
        ...
        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordion1">
          <div class="accordion-body">
            <img src="../Images/8.jpg" class="float-md-end mb-3 ms-md-3" alt="placeholder" style="max-width:250px; max-height:250px;">
              <p>
              <?php
                    include "../Include/printPageGoals.php";
                    printData("1","Decent-Work-And-Economic-Growth");
      ...
      <div class="accordion-item">
        ...
        <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="header2" data-bs-parent="#accordion1">
          <div class="accordion-body">
            ...
            <p>
            <?php
                    printData("2","Decent-Work-And-Economic-Growth");
      ...
      <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordion1">
        <div class="accordion-body">
          <div class="container">
            ...
            <p>
            <?php
                    printData("3","Decent-Work-And-Economic-Growth");
    ...
    <div class="container" id="container2">
      <div class="col">
        ...
        <div class="infoPopup" id="infoPage" style="display: none;" >
          ...
          <?php
                    printData("4","Decent-Work-And-Economic-Growth");
