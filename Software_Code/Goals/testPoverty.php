  ...
  <div class="container">
    <div class="row">
      <div class="col clearfix">
        ...
        <h2>
          The main goal of this development goal is to end Poverty in all its forms everywhere.
        </h2>
        ...
        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordion1">
          <div class="accordion-body">
            <img src="Images/1.png" class="float-md-end mb-3 ms-md-3" alt="placeholder" style="height:300px; width:300px;">
      ...
      <div class="accordion-item">
        ...
        <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="header2" data-bs-parent="#accordion1">
          <div class="accordion-body">
            <img src="Images/1.png" class="float-md-end mb-3 ms-md-3" alt="placeholder" style="height:250px; width:300px;">
                ...
                "type": "geojson",
                  "data": {
                    ...
                    "features": [
                      ...
                      "geometry": {
                        "type": "Point",
                        "coordinates": [-2.926925, 56.488416]
                      },
                      "properties": {
                        "description": "Dundee Bairns",
                        "icon": "marker"
                      }
                      },
                      ...
                      "geometry": {
                        "type": "Point",
                        "coordinates": [-2.986441, 56.488212]
                      },
                      "properties": {
                        "description": "Fighting for Fairness",
                        "icon": "marker"
                      }
                    },

                    {
                      ...
                      "geometry": {
                        "type": "Point",
                        "coordinates": [-3.060323, 56.465238]
                      },
                      "properties": {
                        "description": "Positive Steps Partnership",
                        "icon": "marker"
                      }
                    },

                    {
                      ...
                      "geometry": {
                        "type": "Point",
                        "coordinates": [-2.985899, 56.462464]
                      },
                      "properties": {
