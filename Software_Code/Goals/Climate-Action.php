    ...
    <div class="row">
      <div class="col clearfix">
        ...
        <h2 class="text-center">
          Our main goal to take climate action
        </h2>
        ...
        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordion1">
          <div class="accordion-body">
            <img src="../Images/13.jpg" class="float-md-end mb-3 ms-md-3" alt="placeholder" style="max-width:250px; max-height:250px;">
              <p>
              <?php
