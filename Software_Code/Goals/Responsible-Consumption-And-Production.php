      ...
      <div class="col clearfix">
        ...
        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordion1">
          <div class="accordion-body">
            <img src="../images/12.jpg" class="float-md-end mb-3 ms-md-3" alt="placeholder" style="max-width:250px; max-height:250px;">
              <p>
              <?php
                    include "../Include/printPageGoals.php";

                    printData("1","Responsible-Consumption-And-Production");
        ...
        <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="header2" data-bs-parent="#accordion1">
          <div class="accordion-body">
            ...
            <?php
                    ...
                    printData("2","Responsible-Consumption-And-Production");
        ...
        <div class="accordion-body">
          <div class="container">
            ...
            <?php
                    ...
                    printData("3","Responsible-Consumption-And-Production");
      ...
      <div class="col">
        ...
        <div class="infoPopup" id="infoPage" style="display: none;" >
          ...
          <?php
                    ...
                    printData("4","Responsible-Consumption-And-Production");
