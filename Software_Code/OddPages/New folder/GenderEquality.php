  ...
  <div class="container">
    <div class="row">
      ...
      <h1 class="text-center">Gender Equality</h1>
        ...
        <img src="5.jpg" class="float-md-end mb-3 ms-md-3" alt="placeholder" style="height:300px; width:300px;">
        <p>
                ...
                "type": "geojson",
                  "data": {
                    ...
                    "features": [
                      ...
                      "geometry": {
                        "type": "Point",
                        "coordinates": [-3.023904, 56.457526]
                      },
                      "properties": {
                        "description": "Soroptimists Dundee",
                        "icon": "marker"
                      }
                      },
                    ]},
    ...
    <div class="container" id="container2">
      <div class="col">
        <p>
          Soroptimists Dundee - The Soroptimists are a group of women working together to improve the lives of women and girls locally in Dundee, nationally and internationally.
