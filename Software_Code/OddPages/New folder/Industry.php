  ...
  <div class="container">
    <div class="row">
      ...
      <h1 class="text-center">Industry, Innovation and Infastructure</h1>
        ...
        <img src="9.jpg" class="float-md-end mb-3 ms-md-3" alt="placeholder" style="height:300px; width:300px;">
        <p>
          The main goal of this development goal is to build resilient infrastructure, promote inclusive and sustainable industrialization and foster innovation
        </p>
        <p>
                ...
                "type": "geojson",
                  "data": {
...

                    {
                      ...
                      "geometry": {
                        "type": "Point",
                        "coordinates": [-2.982239, 56.458008]
                      },
                      "properties": {
    ...
    <div class="container" id="container2">
      <div class="col">
      <p>
          MSIP - Michelin Scotland Innovation Parc - world class innovation parc in Dundee for sustainable mobility and decarbonisation. 
          <br>
          <br>
          ...
          <br>
          <br>
          The MILL/ Urban Foresight - Mobility Innovation Living Lab, Dundee. The MILL is transforming Dundee ito a real-world test and experimentation environment for innovative mobility solutions. They provide expert support to large and small businesses. Including access to funding, infrastructure and end-users. *potential for school visits/workshops* 
          <br>
          <br>
          University of Dundee - One of the UK's leading universities, internationally recognised for its expertise across a range of disciplines.
